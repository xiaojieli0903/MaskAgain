...
from engine_for_finetuning import (final_test, merge, train_one_epoch,
...
def get_args():
    ...
    parser.add_argument('--fc_drop_rate',
                        type=float,
                        default=0.0,
                        metavar='PCT',
    ...
    if args.eval:
        ...
        if global_rank == 0:
            ...
            print(
                ...
                f"test videos: Top-1: {final_top1:.2f}%, "
                f"Top-5: {final_top5:.2f}%"
            )
